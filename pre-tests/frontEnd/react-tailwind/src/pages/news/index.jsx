...
export function News() {
  ...
  const _onRetrieveDataProfile = async () => {
    try {
      let results = await axios.get(`http://localhost:8080/any-news`)
      console.log(results)
  ...
  const _onInputNews = async () => {
   ...
   const _onRemovesNews = async (uuid) => {
    try {
    ...
    <div className="mt-12 mb-8 flex flex-col gap-12">
      <Card>
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
         ...
         onClick={() => {
          ...
          <table className="w-full min-w-[640px] table-auto">
            <thead>
              <tr>
                {["Judul", "Isi Berita", "Tanggal", "Action"].map((el) => (
                  <th
                    key={el}
                    ...
                    <tr key={key}>
                      ...
                      <td className={className}>
                        ...
                        <Typography
                          ...
                          href="#"
                          className="text-xs font-semibold text-blue-gray-600"
                          onClick={() => _onRemovesNews(items.id)}
                        >
                          Hapus
                        </Typography>
                      </td>
        ...
        <DialogFooter>
          ...
          {
            change ?
            <Button variant="gradient" color="blue" onClick={_onChangeNews}>
            <span>Update</span>
          </Button> :
          <Button variant="gradient" color="green" onClick={_onInputNews}>
            <span>Save</span>
          </Button>
          }
        </DialogFooter>
